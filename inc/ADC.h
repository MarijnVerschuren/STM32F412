...
typedef enum {	// config_ADC
	ADC_INJ_DISC_DISABLE =		0b0U << 12,
	ADC_INJ_DISC_ENABLE =		0b1U << 12
} ADC_INJ_DISC_t;				// flags[8:32] -> ADC1_CR1
...
typedef enum {	// config_ADC
	ADC_INJ_TRIG_TIM1_CC4 =		0b0000U << 48,
	ADC_INJ_TRIG_TIM1_TRGO =	0b0001U << 48,
	ADC_INJ_TRIG_TIM2_CC1 =		0b0010U << 48,
	ADC_INJ_TRIG_TIM2_TRGO =	0b0011U << 48,
	ADC_INJ_TRIG_TIM3_CC2 =		0b0100U << 48,
	ADC_INJ_TRIG_TIM3_CC4 =		0b0101U << 48,
	ADC_INJ_TRIG_TIM4_CC1 =		0b0110U << 48,
	ADC_INJ_TRIG_TIM4_CC2 =		0b0111U << 48,
	ADC_INJ_TRIG_TIM4_CC3 =		0b1000U << 48,
	ADC_INJ_TRIG_TIM4_TRGO =	0b1001U << 48,
	ADC_INJ_TRIG_TIM5_CC4 =		0b1010U << 48,
	ADC_INJ_TRIG_TIM5_TRGO =	0b1011U << 48,
	ADC_INJ_TRIG_TIM8_CC2 =		0b1100U << 48,
	ADC_INJ_TRIG_TIM8_CC3 =		0b1101U << 48,
	ADC_INJ_TRIG_TIM8_CC4 =		0b1110U << 48,
	ADC_INJ_TRIG_EXTI_15 =		0b1111U << 48
} ADC_INJ_TRIG_t;				// flags[32:] -> ADC1_CR2

typedef enum {    // config_ADC
	ADC_INJ_TRIG_MODE_NONE =	0b00 << 52,
	ADC_INJ_TRIG_MODE_RISING =	0b01 << 52,
	ADC_INJ_TRIG_MODE_FALING =	0b10 << 52,
	ADC_INJ_TRIG_MODE_BOTH =	0b11 << 52
} ADC_INJ_TRIG_MODE_t;
